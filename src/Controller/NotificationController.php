...
class NotificationController extends Controller
{
    ...
    public function unreadCountAction()
    {
        return new JsonResponse([
            'count' => $this->notificationRepository->findUnseenUser($this->getUser())
        ]);
    }
     ...
     */
    public function acknowledgeAction(Notification $notification)
    {
     ...
     */
    public function acknowledgeAllAction()
    {
